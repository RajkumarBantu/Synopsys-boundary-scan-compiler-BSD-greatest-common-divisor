...
#BSD connected to internal scan chain
...
set_scan_path STT_REG -class bsd -view spec -hookup {BSR_SI BSR_SO core/test_si
...
#Define instruction for SCANCH [opcode=1101]
